		...
		<!-- Header -->
			<header id="header">
				<div class="inner">
					...
					<br />
					<h1><strong></strong>Explore my work and let’s connect!</a></h1></strong><br />
					<br />
		...
		<!-- Main -->
			<div id="main">
					...
					<section id="two">
						...
						<div class="row">
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/fulls/churn.jpg" class="image fit thumb"><img src="images/churn.jpg" alt="" /></a>
							...
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/fulls/sqlfull.png" class="image fit thumb"><img src="images/sql.png" alt="" /></a>
							...
							<article class="col-6 col-12-xsmall work-item">
								<a href="images/fulls/netflix.png" class="image fit thumb"><img src="images/netflix.png" alt="" /></a>
				...
				<!-- Three -->
					<section id="three">
						<h2>Get In Touch</h2>
						<form method="post" action="send_email.php"> <!-- PHP script to handle the email -->
...
print 'It took ' + i + ' iterations to sort the deck.';</code></pre>
		...
		<!-- Footer -->
			<footer id="footer">
				<div class="inner">
					<ul class="icons">
						<li><a href="https://www.linkedin.com/in/yawdapaa/" class= "icon brands alt fa-linkedin"><span class="label">Linkedin</span></a></li>
						<li><a href="https://x.com/yaw_dap" class= "icon brands alt fa-twitter"><span class="label">Twitter</span></a></li>
						<li><a href="https://www.facebook.com/yaw.anogyei" class="icon brands alt fa-facebook-f"><span class="label">Facebook</span></a></li>
						<li><a href="https://www.instagram.com/yaw_dap/" class="icon brands alt fa-instagram"><span class="label">Instagram</span></a></li>
						<li><a href="https://github.com/yawdap" class="icon brands alt fa-github"><span class="label">GitHub</span></a></li>
						<li><a href="mailto:dapaayaw@hotmail.com" class="icon solid alt fa-envelope"><span class="label">Email</span></a></li>
					</ul>
					<ul class="copyright">
